...
static const char *fonts[]          = { "FontAwesome:size=13",  "monospace:size=13" };
...
static const char *termin[] = { "terminator", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ControlMask,           XK_p,      spawn,          SHCMD("dmenu_run -nb '#0d0606' -sb '#EC9E5A' -g 3 -l 10") },
...
static Button buttons[] = {
	...
	{ ClkLtSymbol,          0,              Button3,        cyclelayout,    {.i = +1 } }, /* Cyclelayout by clicking on layout button */
